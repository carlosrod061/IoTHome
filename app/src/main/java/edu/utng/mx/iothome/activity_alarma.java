...
public class activity_alarma extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnVolver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(activity_alarma.this,MainActivity.class);
        ...
        btnVerEstadisticas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(activity_alarma.this,activity_alarma_Estadisticas.class);
                startActivity(intent);
        ...
        stEncendidoManual.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                databaseReference.child("Alarma").updateChildren(dispositivoMap);
            }
        });
