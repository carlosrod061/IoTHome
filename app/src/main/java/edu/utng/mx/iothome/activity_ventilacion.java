...
public class activity_ventilacion extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnVolver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(activity_ventilacion.this,MainActivity.class);
        ...
        btnVerEstadisticas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(activity_ventilacion.this,activity_ventilacion_Estadisticas.class);
                startActivity(intent);
        ...
        stEncendidoManual.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                databaseReference.child("Ventilacion").updateChildren(dispositivoMap);
            }
        });
