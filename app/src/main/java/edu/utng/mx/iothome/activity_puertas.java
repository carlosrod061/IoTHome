...
public class activity_puertas extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnVolver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(activity_puertas.this,MainActivity.class);
        ...
        btnVerEstadisticas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(activity_puertas.this,activity_puertas_Estadisticas.class);
                startActivity(intent);
        ...
        stEncendidoManual.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                databaseReference.child("Puerta").updateChildren(dispositivoMap);
            }
        });
