...
public class activity_ventilacion_Estadisticas extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ventilacion__estadisticas);
        ...
        btnVolver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(activity_ventilacion_Estadisticas.this,activity_ventilacion.class);
    ...
    private void listarDatos(){
        ...
        databaseReference.child("Ventilacion").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {

                if (dataSnapshot.exists()) {

                    String nombreDispositivo = dataSnapshot.child("nombreVentilador").getValue().toString();
