...
public class activity_luces_estadisticas extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_luces_estadisticas);
        ...
        btnVolver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(activity_luces_estadisticas.this,activity_luces.class);
        ...
        databaseReference.child("Luz").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    String nombreDispositivo = dataSnapshot.child("nombreLuz").getValue().toString();
